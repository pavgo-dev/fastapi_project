...
async def get_balance(
    ...
    return await wallets_service.get_balance(session, current_user, wallet_name)
...
async def create_wallet(
    ...
    return await wallets_service.create_wallet(session, current_user, wallet)
...
async def get_wallets(
    ...
    wallets_list = await wallets_service.get_wallets(session, current_user)
